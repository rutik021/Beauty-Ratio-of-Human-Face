...
class GoldenFace:
    ...
    def __init__(self, path):
        ...
        for faceBorders in self.faces:
            ...
            _, landmarks = self.landmark_detector.fit(self.image_gray, [faceBorders])
            self.facePoints = landmarks[0][0]
            break
    ...
    def similarity_ratio(self):
        ...
        filepath = pkg_resources.resource_filename(__name__, "goldenFaceVec.yaml")
        goldenFace = functions.load_face_vec(filepath)
